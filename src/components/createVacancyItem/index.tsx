...
import styles from '@/styles/components/CreateVacancyItem.module.scss';

import Delete from '@/assets/icon/remove.svg';
import Edit from '@/assets/icon/edit.svg';

interface CreateVacancyItemProps {
  name: string;
  descriptions: string;
  id: string;
  vacancy: { id: string }[];
...
export const CreateVacancyItem: FC<CreateVacancyItemProps> = ({
  vacancy,
  name,
  descriptions,
  id,
